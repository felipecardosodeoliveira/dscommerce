package com.fcolabs.dscommerce.controllers.handlers;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<CustomError> databaseIntegrityViolation(DatabaseException e, HttpServletRequest request) {
